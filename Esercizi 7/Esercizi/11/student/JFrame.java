...
/**
   ...
   Modified 6/18/2015 by Stephen Gilbert
   Used code from BJLO Canvas.java as a model for saving the picture.
   Designed to be used for BJOE 6 - Problem E8.13 and E8.14 where the
   students create a new picture. Only want the output file written
   for the final picture, not for the intermediate ones.
*/
      ...
      Thread watcherThread = new Thread()
      {
          public void run()
          {
              try
              {
                  ...
                  // Only save empty Picture names
                  // Will change Picture class so this is changed in load.
                  // Designed to be used for BJOE 6 - Problem E8.13 and E8.14 where the
                  // students create a new picture. Only want the output file written
                  // for the final picture, not for the intermediate ones.
                  if (title.equals(""))
