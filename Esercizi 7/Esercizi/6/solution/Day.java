/**
   A Day object represents a day in the 
   Julian/Gregorian calendar.
   This version is mutable.
*/
...
public class Day
{
   ...
   */
   ...
   /**
      Changes this day so that it is a 
      certain number of days away from this day.
   ...
   */
   public void addDays(int n)
   {
      while (n > 0)
      {
         nextDay();  // mutate the current object
         n--;
      }
      while (n < 0)
      {
         previousDay(); // mutate the current object
         n++;
      }
   }
   ...
   */
   ...
   {
      int n = 0;
      // Construct a new Day object
      Day d = new Day(year, month, date);
      while (d.compareTo(other) > 0)
      {
         d.previousDay(); // mutate the new object
         n++;
      }
      while (d.compareTo(other) < 0)
      {
         d.nextDay(); // mutate the new object
         n--;
      }
      return n;
   }
   ...
   */
   ...
   /**
      Changes this day to become the next day.
   */
   public void nextDay()
   {
      int y = year;
   ...
   /**
      Changes this day to become the previous day.
   */
